...
BINARY_SEARCH_TESTS: dict[str, list[TestCase]] = {
    ...
    "order_agnostic_search": [
        ...
        TestCase("single not found", (([5], 3),), -1),
        ...
        TestCase("negative ascending", (([-10, -5, -1], -5),), 1),
    ],
    "ceiling_of_number": [
        ...
        TestCase("single element exact", (([5], 5),), 0),
        TestCase("single element larger", (([5], 7),), -1),
    ...
    "floor_of_number": [
        ...
        TestCase("single element exact", (([5], 5),), 0),
        TestCase("single element smaller", (([5], 3),), -1),
    ...
    "number_range": [
        ...
        TestCase("single not found", (([1], 5),), [-1, -1]),
        ...
        TestCase("negative numbers", (([-5, -3, -3, -1, 0], -3),), [1, 2]),
        TestCase("target smaller than all", (([1, 2, 3], 0),), [-1, -1]),
        TestCase("target larger than all", (([1, 2, 3], 5),), [-1, -1]),
    ],
    ...
    "search_in_infinite_array": [
        ...
        TestCase("negative numbers", (([-10, -5, 0, 5, 10], -5),), 1),
    ],
    ...
    "search_rotated_array": [
        ...
        TestCase("two elements not rotated", (([1, 2], 2),), 1),
        ...
        TestCase("negative numbers", (([-3, -2, -1, 5, 6, -5, -4], -4),), 6),
        TestCase("target smaller than all", (([4, 5, 6, 7, 0, 1, 2], -1),), -1),
        TestCase("target larger than all", (([4, 5, 6, 7, 0, 1, 2], 10),), -1),
    ],
}
