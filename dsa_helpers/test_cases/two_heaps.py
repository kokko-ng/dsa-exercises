...
TWO_HEAPS_TESTS = {
    "find_median_from_stream": [
        TestCase("basic", (({"ops": ["add", "add", "median", "add", "median"], "vals": [1, 2, None, 3, None]},),), [None, None, 1.5, None, 2.0], is_class_test=True),
        TestCase("single", (({"ops": ["add", "median"], "vals": [5, None]},),), [None, 5.0], is_class_test=True),
        TestCase("sorted input", (({"ops": ["add", "add", "add", "median"], "vals": [1, 2, 3, None]},),), [None, None, None, 2.0], is_class_test=True),
    ],
